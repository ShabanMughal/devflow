...
const popularTags = [
    ...
    {_id: "4", name: "HTML", questions: 80},
    {_id: "5", name: "Node.js", questions: 120},
    {_id: "6", name: "Next.js", questions: 90},
]

const RightSidebar = () => {

  return (
    <section className='pt-24 custom-scrollbar background-light900_dark200 light-border sticky right-0 top-0 flex h-screen w-[350px] 
